import{I as t,l as o,m as r,p as l,G as n,v as s}from"./index-BrdItevI.js";const e="gaussianSplattingVoxelVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;t.ShadersStore[e]||(t.ShadersStore[e]=i);const p=[o,r,l,n,s];for(const a of p)t.IncludesShadersStore[a.name]||(t.IncludesShadersStore[a.name]=a.shader);const m={name:e,shader:i};export{m as gaussianSplattingVoxelVertexShader};
