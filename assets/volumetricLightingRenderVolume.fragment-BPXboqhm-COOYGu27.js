import{I as e,ab as r,C as n}from"./index-BKqqihTF.js";const t="volumetricLightingRenderVolumePixelShader",o=`#include<__decl__sceneFragment>
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=o);const a=[r,n];for(const i of a)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const c={name:t,shader:o};export{c as volumetricLightingRenderVolumePixelShader};
