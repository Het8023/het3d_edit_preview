import{I as e,$ as o,j as i,k as s,i as n,g as l,q as f,P as u,s as d,z as c,n as p}from"./index-DdEn_fc_.js";const r="gaussianSplattingVertexShader",a=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=a);const x=[o,i,s,n,l,f,u,d,c,p];for(const t of x)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const S={name:r,shader:a};export{S as gaussianSplattingVertexShaderWGSL};
