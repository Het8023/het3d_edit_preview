import{I as t,M as r,C as o,r as l,G as n,O as s}from"./index-DdEn_fc_.js";const e="gaussianSplattingVoxelVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;t.ShadersStore[e]||(t.ShadersStore[e]=i);const p=[r,o,l,n,s];for(const a of p)t.IncludesShadersStore[a.name]||(t.IncludesShadersStore[a.name]=a.shader);const m={name:e,shader:i};export{m as gaussianSplattingVoxelVertexShader};
