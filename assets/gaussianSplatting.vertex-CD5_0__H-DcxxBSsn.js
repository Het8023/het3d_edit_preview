import{I as e,Y as t,d as r,U as n,R as l,t as s,L as f,b as d,E as c,j as p,f as S,g as u,h as _}from"./index-DOHxn-_P.js";const a="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=i);const m=[t,r,n,l,s,f,d,c,p,S,u,_];for(const o of m)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);const D={name:a,shader:i};export{D as gaussianSplattingVertexShader};
