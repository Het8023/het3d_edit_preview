import{I as e,l as t,m as r,p as l,G as n,t as s,Q as f,f as d,u as c,v as p,C as S,w as u,x as _}from"./index-BrdItevI.js";const a="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=i);const m=[t,r,l,n,s,f,d,c,p,S,u,_];for(const o of m)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);const D={name:a,shader:i};export{D as gaussianSplattingVertexShader};
