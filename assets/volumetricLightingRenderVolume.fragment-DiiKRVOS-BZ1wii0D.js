import{I as e,V as r,w as o}from"./index-DOHxn-_P.js";const i="volumetricLightingRenderVolumePixelShader",n=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=n);const s=[r,o];for(const t of s)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const a={name:i,shader:n};export{a as volumetricLightingRenderVolumePixelShaderWGSL};
