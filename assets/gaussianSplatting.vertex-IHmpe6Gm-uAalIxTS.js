import{I as e,M as r,C as t,r as l,G as n,J as s,h as f,c as d,l as c,O as p,R as S,x as u,m as _}from"./index-DdEn_fc_.js";const a="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=i);const m=[r,t,l,n,s,f,d,c,p,S,u,_];for(const o of m)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);const D={name:a,shader:i};export{D as gaussianSplattingVertexShader};
