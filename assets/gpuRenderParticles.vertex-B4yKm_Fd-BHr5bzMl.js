import{I as e,r as i,e as n,X as s,n as a,y as f,z as v}from"./index-DOHxn-_P.js";const r="gpuRenderParticlesVertexShader",o=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=o);const l=[i,n,s,a,f,v];for(const t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const c={name:r,shader:o};export{c as gpuRenderParticlesVertexShaderWGSL};
