import{I as e,q as o,c as i,B as n,r as s,S as l,J as f,L as u,n as d,X as c,d as p}from"./index-BrdItevI.js";const r="gaussianSplattingVertexShader",a=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=a);const x=[o,i,n,s,l,f,u,d,c,p];for(const t of x)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const S={name:r,shader:a};export{S as gaussianSplattingVertexShaderWGSL};
