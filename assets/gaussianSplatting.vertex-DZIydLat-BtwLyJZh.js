import{I as e,V as o,w as i,N as s,r as n,e as l,X as f,$ as u,n as d,y as p,z as c}from"./index-DOHxn-_P.js";const r="gaussianSplattingVertexShader",a=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=a);const x=[o,i,s,n,l,f,u,d,p,c];for(const t of x)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const S={name:r,shader:a};export{S as gaussianSplattingVertexShaderWGSL};
