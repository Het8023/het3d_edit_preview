import{I as e,B as s,ae as o}from"./index-BrdItevI.js";const t="fibonacci",n=`fn rcp(x: f32)->f32
{return 1./x;}
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);const u={name:t,shader:n},i="diffusionProfile",l=`uniform diffusionS: array<vec3f,5>;uniform diffusionD: array<f32,5>;uniform filterRadii: array<f32,5>;
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=l);const c={name:i,shader:l},a="subSurfaceScatteringPixelShader",f=`#include<helperFunctions>
#include<fibonacci>
...
`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=f);const p=[s,u,o,c];for(const r of p)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const m={name:a,shader:f};export{m as subSurfaceScatteringPixelShaderWGSL};
